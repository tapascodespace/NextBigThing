...
const featureBlocks = [
  ...
  },
  {
    num: "05",
    label: "LIVE DATA",
    title: "A DATA PRODUCT,\nNOT JUST A TRADE",
    desc: "Open positions form a live probability curve, updated in real time by the crowd.",
    highlight: "The data Bloomberg and macro funds can't buy anywhere else.",
    side: "left" as const,
  },
];
...
const personas = [
  {
    ...
    subtitle: "& Spread Traders",
    body: "You think in magnitudes: goal differences, points margins. One clean instrument, transparent payoff, no hidden vig.",
    tag: "BETFAIR · IG INDEX · SPREADEX",
  },
  {
    icon: "📈",
    title: "Macro Traders",
    subtitle: "& Hedge Funds",
    body: "Fed rate views, earnings prints, GDP figures. Positions that binary contracts can't express. Margined, daily-settled, institutional-grade.",
  ...
  },
  {
    ...
    body: "You know the mechanism works. You've felt the ceiling of yes/no. This is what comes next.",
    tag: "NEXT GENERATION",
  },
  {
    icon: "🧮",
    ...
    subtitle: "& Analysts",
    body: "Not a probability. A full distribution. Continuously updated by participants staking real margin on their precision.",
    tag: "DATA PRODUCT",
  },
];
